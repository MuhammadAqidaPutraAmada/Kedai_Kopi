# APLIKASI KEDAI KOPI
Aplikasi Kedai Kopi ini adalah tugas dari mata kuliah OOP, dalam aplikasi ini user dapat memesan beberapa menu kopi yang tersedia dan menentukan jumlah menu yang dipesan. Sistem akan melakukan perhitungan meliputi harga pesanan, diskon dan ppn sehingga akan ditotal menjadi harga yang harus dibayar.
## Penjelasan Program
